    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.restaurant_menu, size: 20), text: 'Alle'),
            Tab(icon: Icon(Icons.schedule, size: 20), text: 'Neu'),
            Tab(icon: Icon(Icons.favorite, size: 20), text: 'Beliebt'),
            Tab(icon: Icon(Icons.bookmark, size: 20), text: 'Gespeichert'),
            Tab(icon: Icon(Icons.person, size: 20), text: 'Meine'),
          ],
        ),
      ),
      body: TabBarView(
